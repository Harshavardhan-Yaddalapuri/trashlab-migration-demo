...
/**
 * Demo store. The URL is the single source of truth for the app phase.
 * Each phase maps to a real route:
 *   /                    -> landing
 *   /migrate             -> connect
 *   /migrate/processing  -> processing
 *   /workspace           -> workspace
 *
...
export type DemoPhase = "landing" | "connect" | "processing" | "workspace";
